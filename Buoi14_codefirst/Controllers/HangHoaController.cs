...
namespace Buoi14_codefirst.Controllers
{
    public class HangHoaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaHH,TenHH,SoLuong,DonGia,Hinh,MaLoai")] HangHoa hangHoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaHH,TenHH,SoLuong,DonGia,Hinh,MaLoai")] HangHoa hangHoa)
        {
            if (id != hangHoa.MaHH)
            {
                return NotFound();
